...
function Derecha(){
 ...
 this.pasarTurno=function(partida){
        //ver el nick del qe tiene el turno
        //calcular el inide en el array orden turno
...
function Inicial(){
    ...
    this.jugarCarta=function(carta,nick,partida){
       console.log("La partida no ha comenxzado")
    } 
    this.pasarTurno=function(nick,partida){
        console.log("La partid ya ha comenzado")
    }
}
function Jugando(){
    this.nombre="jugando";
